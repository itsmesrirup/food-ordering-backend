...
public class JwtService {
    ...
    // IMPORTANT: Generate a secure secret key and put it in your application.properties
    // For example: application.security.jwt.secret-key=your-super-secret-long-random-string
